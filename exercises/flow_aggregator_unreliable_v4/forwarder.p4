...
typedef bit<16> monitorBitmap_t;
...
control MyIngress(inout headers hdr,
    ...
    /* acked_monitor_number is a bitmap*/
    register <monitorBitmap_t> (MAX_QUERY_ID) acked_monitor_number;
